...
extern "C" {
    ...
    #[doc = "  The caller is responsible for freeing the error message."]
    #[doc = ""]
    #[doc = " NOTE: This call does not store references to the passed in c-strings."]
...
extern "C" {
    ...
    #[doc = " true."]
    #[doc = ""]
    #[doc = " \\param flag_name The name of the flag without leading punctuation"]
    #[doc = "                  (example: \"enable_asserts\")."]
